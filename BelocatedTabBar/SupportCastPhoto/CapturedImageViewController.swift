...
class CapturedImageViewController: UIViewController {
    ...
    @IBOutlet weak var imageBgDashedLine: UIImageView!
...
//        descriptionView.addBorder(withHexColor: "#FFCD00")
        descriptionView.applyGradient()
        descriptionView.layer.masksToBounds = true
        descriptionView.layer.borderWidth = 1
        descriptionView.layer.borderColor = UIColor(red: 200/255, green: 200/255, blue: 200/255, alpha: 1).cgColor
        descriptionView.layer.cornerRadius = 16
        
        //donebutton
        doneBtn.addRoundCorner(radius: 17.5, borderWidth: 0, borderColor: UIColor.black)
        //doneBtn.layer.cornerRadius = 28
        // dashedline
        imageBgDashedLine.layer.cornerRadius = 0.5 * imageBgDashedLine.bounds.size.width
        imageBgDashedLine.addDashedBorder()
    }

...
class SupportCastMainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        whyWeBackgroundView.layer.masksToBounds = true
        whyWeBackgroundView.layer.borderWidth = 1
        whyWeBackgroundView.layer.borderColor = UIColor(red: 200/255, green: 200/255, blue: 200/255, alpha: 1).cgColor
        whyWeBackgroundView.layer.cornerRadius = 16
...
extension SupportCastMainViewController {
